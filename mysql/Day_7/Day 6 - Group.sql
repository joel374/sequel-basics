...
INSERT INTO Member (Member_id, NIK, Name, Place_of_Birth, Date_of_Birth, Address) VALUES ('1', '312298259', 'Deni', 'Jakarta', ' 1980-06-03', '47 MySakila Drive');
INSERT INTO Member (Member_id, NIK, Name, Place_of_Birth, Date_of_Birth, Address) VALUES ('2', '321242525', 'Daniel', 'Yogyakarta', '1993-07-11', '1411 Lillydale Drive');
INSERT INTO Member (Member_id, NIK, Name, Place_of_Birth, Date_of_Birth, Address) VALUES ('3', '312223424', 'Fitri', 'Bandung', '1998-01-14', '478 Joliet Way');
INSERT INTO Member (Member_id, NIK, Name, Place_of_Birth, Date_of_Birth, Address) VALUES ('4', '327283759', 'Anggi', 'Jakarta', '1990-03-23', '613 Korolev Drive');
INSERT INTO Member (Member_id, NIK, Name, Place_of_Birth, Date_of_Birth, Address) VALUES ('5', '398787472', 'Rian', 'Tangerang', '1992-02-17', '1531 Sal Drive');
...
INSERT INTO Staff (Branch_ID, Name, Schedule) VALUES (1,'Yuke', 'Pagi');
INSERT INTO Staff (Branch_ID,Name, Schedule) VALUES (1,'Santi', 'Sore');
INSERT INTO Staff (Branch_ID,Name, Schedule) VALUES (2,'Anna', 'Pagi');
INSERT INTO Staff (Branch_ID,Name, Schedule) VALUES (2,'Dinda', 'Sore'); 
...
-- SELECT M.Name, SUM(Total) FROM Member AS M
-- INNER JOIN Activities AS A ON M.Member_id = A.Member_id
-- INNER JOIN Transaction AS T On M.Member_id = T.Member_id
